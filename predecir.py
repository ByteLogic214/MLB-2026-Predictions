...
def run():
    print('Iniciando ejecución de producción...')
...
'
    ...
    for juego in cuotas:
        ...
        try:
            ...
            if edge > 0.05:
                picks += 1
                reporte += f'✅ {juego[ "away_team" ]} @ {juego[ "home_team" ]}
'
                reporte += f'🎯 Pick: {juego[ "home_team" ]} | Edge: +{edge*100:.1f}%
...
'
    ...
    if picks > 0:
        ...
        print('No se encontró valor hoy.')
